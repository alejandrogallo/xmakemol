...
ACLOCAL = /home/ale/Downloads/xmakemol-5.16/missing aclocal-1.4
AUTOCONF = autoconf
AUTOMAKE = /home/ale/Downloads/xmakemol-5.16/missing automake-1.4
...
EXTRA_xmakemol_SOURCES =  	bbox.h 	config.h 	draw.h 	globals.h  	view.h 	bonds.h 	defs.h 	gl_funcs.h 	vectors.h 	xm_logo.h 	gl2ps.h


xmakemol_SOURCES =  	animate.c 	basename.c 	bbox.c 	canvas.c 	control.c 	crystal.c 	draw.c 	edit.c 	fig.c 	file.c 	frames.c 	gl_funcs.c 	help.c 	menus.c 	region.c 	rotate.c 	sort.c 	store.c 	track.c 	translate.c 	utils.c 	vectors.c 	view.c 	xmakemol.c  	gl2ps.c


xmakemol_LDADD = -lGL -lGLU -lGLw -lglut -lXm -lXt  -lXext -lXi -lX11
